        ...
        return (
          <div 
            ...
            style={{
              ...
              boxShadow: isSelected ? '0 8px 32px rgba(0, 0, 0, 0.4), 0 0 15px rgba(38, 139, 210, 0.1)' : 'none',
          ...
          <div style={{
            ...
            border: isSelected ? '1px solid var(--accent-blue)' : '1px solid var(--border-glass)',
            flexShrink: 0,
            boxShadow: isSelected ? '0 0 10px rgba(38, 139, 210, 0.2)' : 'none'
          }}>
            <img 
          ...
          <div className="launch-icon" style={{ 
            ...
            display: 'flex',
            alignItems: 'center',
            background: isSelected ? 'rgba(38, 139, 210, 0.15)' : 'transparent',
            padding: '8px',
            borderRadius: '8px',
